            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <motion.div
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {['React', 'JavaScript', 'TypeScript', 'Tailwind CSS', 'Next.js', 'Node.js', 'Git', 'Figma'].map((tech, index) => (
                            <motion.span
                                key={tech}
                                ...
                                className="px-6 py-3 bg-gradient-to-r from-violet-600/20 to-purple-600/20 border border-violet-500/30 rounded-full text-violet-300 font-medium hover:border-violet-400 transition-all duration-300">
                                {tech}
                            </motion.span>
                        ))}
                    </div>
