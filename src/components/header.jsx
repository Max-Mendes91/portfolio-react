...
const Header = ({ openContactForm }) => {
    ...
    return (
        <motion.header
            ...
            className={`${isDesktop ? 'fixed top-0 left-0 w-full z-50' : 'absolute top-0 left-0 w-full z-50'} bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-sm transition-all duration-300`}
        >
            ...
            >
                ...
                <div className='pt-10 border-t border-gray-200 dark:border-gray-700'>
                    ...
                    <button
                        ...
                        className='mt-4 block w-full px-4 py-2 rounded-lg bg-gradient-to-r from-violet-600 via-violet-500 to-violet-400 text-white font-bold'
                    >
                        Contact Me
                    </button>
                </div>
