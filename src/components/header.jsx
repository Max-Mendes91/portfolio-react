                    ...
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <form className='space-y-4'>
                                ...
                                <div>
                                    <label htmlFor="Message" className='block text-sm font-medium text-gray-300 mb-1'>How can we help you?</label>
                                    <textarea rows='4' id="message" placeholder='Your Name' className='w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-700'>
                                    </textarea>
                                </div>
                                <motion.button
                                    type="submit"
                                    ...
                                    whileTap={{ scale: 0.97 }}
                                    className='w-full px-4 py-2 bg-gradient-to-r from-violet-600 to-violet-400 hover:from-violet-700 hover:to-purple-700 transition-all duration-300 rounded-lg shadow-md hover:shadow-lg hover:shadow-violet-600/50'>Send Message
                                </motion.button>
                            </form>
