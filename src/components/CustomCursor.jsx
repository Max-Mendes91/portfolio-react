...
const CustomCursor = () => {
    ...
    useEffect(() => {
        ...
        const xToBorder = gsap.quickTo(cursorBorder, 'x', { duration: 0.6, ease: 'power3.out' });
        const yToBorder = gsap.quickTo(cursorBorder, 'y', { duration: 0.6, ease: 'power3.out' });
        ...
        const handleMouseLeave = () => {
            gsap.to([cursor, cursorBorder], { scale: 1, duration: 0.3 });
        }
